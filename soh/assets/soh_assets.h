...
#define dgTitleSevenSagesSubtitleTex "__OTR__objects/object_mag/gTitleSevenSagesSubtitleTex"
static const ALIGN_ASSET(2) char gTitleSevenSagesSubtitleTex[] = dgTitleSevenSagesSubtitleTex;
