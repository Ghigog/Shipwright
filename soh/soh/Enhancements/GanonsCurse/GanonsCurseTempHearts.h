 ...
 *
 * Split out from GanonsCurseSunsSong.cpp because the health bookkeeping has to run every frame and
...
void GanonsCurseGrantTempHearts(void);
...
void GanonsCurseStripTempHearts(void);
...
int GanonsCurseTempHeartStartIndex(void);
