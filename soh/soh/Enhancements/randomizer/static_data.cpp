...
// >>> GANONS_CURSE_GENERATED: STATIC_HINT_MAP - edit data/npc-hints.json, not this
  ...
  {RH_NPC_SHOP_GORON, StaticHintInfo(HINT_TYPE_ITEM, {RHT_NPC_SHOP_GORON}, RSK_NPC_HINTS, true, {RC_GC_SHOP_ITEM_1})},
  ...
  {RH_NPC_SHOP_KOKIRI, StaticHintInfo(HINT_TYPE_ITEM, {RHT_NPC_SHOP_KOKIRI}, RSK_NPC_HINTS, true, {RC_KF_SHOP_ITEM_1})},
  ...
  {RH_NPC_SHOP_BAZAAR_KAK, StaticHintInfo(HINT_TYPE_ITEM, {RHT_NPC_SHOP_BAZAAR_KAK}, RSK_NPC_HINTS, true, {RC_KAK_BAZAAR_ITEM_8})},
  {RH_NPC_SHOP_BAZAAR_MARKET, StaticHintInfo(HINT_TYPE_ITEM, {RHT_NPC_SHOP_BAZAAR_MARKET}, RSK_NPC_HINTS, true, {RC_MARKET_BAZAAR_ITEM_8})},
  ...
  {RH_NPC_SHOP_MASK, StaticHintInfo(HINT_TYPE_AREA, {RHT_NPC_SHOP_MASK}, RSK_NPC_HINTS, true, {}, {RG_GORON_TUNIC})},
  {RH_NPC_SHOP_ZORA, StaticHintInfo(HINT_TYPE_ITEM, {RHT_NPC_SHOP_ZORA}, RSK_NPC_HINTS, true, {RC_ZD_SHOP_ITEM_1})},
