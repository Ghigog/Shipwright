...
void RandomizerOnVanillaBehaviorHandler(GIVanillaBehavior id, bool* should, va_list originalArgs) {
    ...
    switch (id) {
        ...
        // Seven Sages: the outer wall gate onto the Haunted Wasteland. Unconditionally open -
        ...
        // vanilla gatekeeping this replaces exists to pace a story quest Seven Sages doesn't run.
        case VB_GF_WEST_GATE_BE_OPEN: {
            *should = true;
            break;
        }
        // Seven Sages: never let EnDu_Init's own first-meeting cutscene fire - it competes with
        // SevenSagesOpenings.cpp's re-fired gGoronCityIntroCs for the same csCtx.segment pointer,
        ...
        // effect outside Seven Sages sage spawns.
        case VB_PLAY_DARUNIA_FIRST_MEETING_CS: {
            *should = false;
            break;
        }
        // Seven Sages: Darunia's chamber, both doors. Neither door-opening condition (Zelda's
