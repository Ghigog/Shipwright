...
// >>> SEVEN_SAGES_GENERATED: RH_NPC - edit data/npc-hints.json, not this
RANDO_ENUM_ITEM(RH_NPC_HC_GUARD)
RANDO_ENUM_ITEM(RH_NPC_HC_MALON)
RANDO_ENUM_ITEM(RH_NPC_DMT_GORON_BOMB_FLOWER)
RANDO_ENUM_ITEM(RH_NPC_DMT_GORON_DC)
RANDO_ENUM_ITEM(RH_NPC_DMT_GORON_FAIRY)
RANDO_ENUM_ITEM(RH_NPC_DMT_GORON_ROLLING)
RANDO_ENUM_ITEM(RH_NPC_GV_GERUDO_FLOOR)
RANDO_ENUM_ITEM(RH_NPC_GV_MUTOH)
RANDO_ENUM_ITEM(RH_NPC_GF_GERUDO_CARD_GIVER)
RANDO_ENUM_ITEM(RH_NPC_GF_GERUDO_GATE_GUARD)
RANDO_ENUM_ITEM(RH_NPC_GF_GERUDO_GATE_OP)
RANDO_ENUM_ITEM(RH_NPC_GF_GERUDO_NORMAL)
RANDO_ENUM_ITEM(RH_NPC_GF_GERUDO_PATROL)
RANDO_ENUM_ITEM(RH_NPC_GF_GERUDO_STATIONARY)
RANDO_ENUM_ITEM(RH_NPC_GF_GERUDO_TG_GUARD)
RANDO_ENUM_ITEM(RH_NPC_TH_CARP_1TORCH)
RANDO_ENUM_ITEM(RH_NPC_TH_CARP_DEAD_END)
RANDO_ENUM_ITEM(RH_NPC_TH_CARP_DOUBLE)
RANDO_ENUM_ITEM(RH_NPC_TH_CARP_STEEP)
RANDO_ENUM_ITEM(RH_NPC_GC_DARUNIA)
RANDO_ENUM_ITEM(RH_NPC_GC_GORON_ENTRANCE)
RANDO_ENUM_ITEM(RH_NPC_GC_GORON_GENERIC)
RANDO_ENUM_ITEM(RH_NPC_GC_GORON_ISLAND)
RANDO_ENUM_ITEM(RH_NPC_GC_GORON_LINK)
RANDO_ENUM_ITEM(RH_NPC_GC_GORON_LOST_WOODS)
RANDO_ENUM_ITEM(RH_NPC_GC_GORON_LOWEST)
RANDO_ENUM_ITEM(RH_NPC_GC_GORON_ROLLING_BIG)
RANDO_ENUM_ITEM(RH_NPC_GC_GORON_STAIRWELL)
RANDO_ENUM_ITEM(RH_NPC_SHOP_GORON)
RANDO_ENUM_ITEM(RH_NPC_DAMPE_HUT)
RANDO_ENUM_ITEM(RH_NPC_GY_DAMPE)
RANDO_ENUM_ITEM(RH_NPC_GY_KID)
RANDO_ENUM_ITEM(RH_NPC_HW_CHEST_TIP)
RANDO_ENUM_ITEM(RH_NPC_KAK_CARPENTERS_SON)
RANDO_ENUM_ITEM(RH_NPC_KAK_CARP_ICHIRO)
RANDO_ENUM_ITEM(RH_NPC_KAK_CARP_JIRO)
RANDO_ENUM_ITEM(RH_NPC_KAK_CARP_SABOORO)
RANDO_ENUM_ITEM(RH_NPC_KAK_CARP_SHIRO)
RANDO_ENUM_ITEM(RH_NPC_KAK_CUCCO_GIRL)
RANDO_ENUM_ITEM(RH_NPC_KAK_HY_AHG_2)
RANDO_ENUM_ITEM(RH_NPC_KAK_HY_BJI_7)
RANDO_ENUM_ITEM(RH_NPC_KAK_HY_BOJ_10)
RANDO_ENUM_ITEM(RH_NPC_KAK_HY_BOJ_12)
RANDO_ENUM_ITEM(RH_NPC_KAK_HY_BOJ_9)
RANDO_ENUM_ITEM(RH_NPC_KAK_MUTOH)
RANDO_ENUM_ITEM(RH_NPC_KAK_ROOF_GUY)
RANDO_ENUM_ITEM(RH_NPC_GUEST_HY_AHG_17)
RANDO_ENUM_ITEM(RH_NPC_GUEST_HY_AHG_2)
RANDO_ENUM_ITEM(RH_NPC_GUEST_HY_AOB)
RANDO_ENUM_ITEM(RH_NPC_GUEST_HY_BJI_7)
RANDO_ENUM_ITEM(RH_NPC_GUEST_HY_BOB_18)
RANDO_ENUM_ITEM(RH_NPC_GUEST_HY_BOJ_9)
RANDO_ENUM_ITEM(RH_NPC_IMPAS_HY_BOJ_10)
RANDO_ENUM_ITEM(RH_NPC_SHOP_KAK_POTION)
RANDO_ENUM_ITEM(RH_NPC_WINDMILL_MAN)
RANDO_ENUM_ITEM(RH_NPC_FADO)
RANDO_ENUM_ITEM(RH_NPC_KNOW_IT_ALL_BROS)
RANDO_ENUM_ITEM(RH_NPC_KOKIRI_0)
RANDO_ENUM_ITEM(RH_NPC_KOKIRI_1)
RANDO_ENUM_ITEM(RH_NPC_KOKIRI_10)
RANDO_ENUM_ITEM(RH_NPC_KOKIRI_11)
RANDO_ENUM_ITEM(RH_NPC_KOKIRI_2)
RANDO_ENUM_ITEM(RH_NPC_KOKIRI_3)
RANDO_ENUM_ITEM(RH_NPC_KOKIRI_4)
RANDO_ENUM_ITEM(RH_NPC_KOKIRI_5)
RANDO_ENUM_ITEM(RH_NPC_KOKIRI_6)
RANDO_ENUM_ITEM(RH_NPC_KOKIRI_7)
RANDO_ENUM_ITEM(RH_NPC_KOKIRI_8)
RANDO_ENUM_ITEM(RH_NPC_KOKIRI_9)
RANDO_ENUM_ITEM(RH_NPC_SHOP_KOKIRI)
RANDO_ENUM_ITEM(RH_NPC_TWINS_HOUSE)
RANDO_ENUM_ITEM(RH_NPC_LH_PROFESSOR)
RANDO_ENUM_ITEM(RH_NPC_INGO)
RANDO_ENUM_ITEM(RH_NPC_MALON_CORRAL)
RANDO_ENUM_ITEM(RH_NPC_MALON_RANCH)
RANDO_ENUM_ITEM(RH_NPC_TALON)
RANDO_ENUM_ITEM(RH_NPC_MARKET_GUARD_HOUSE)
RANDO_ENUM_ITEM(RH_NPC_MKT_CUCCO_GIRL)
RANDO_ENUM_ITEM(RH_NPC_MKT_DANCERS)
RANDO_ENUM_ITEM(RH_NPC_MKT_GORON_BAZAAR)
RANDO_ENUM_ITEM(RH_NPC_MKT_GUARD)
RANDO_ENUM_ITEM(RH_NPC_MKT_HAGGLERS)
RANDO_ENUM_ITEM(RH_NPC_MKT_HY_AHG_13)
RANDO_ENUM_ITEM(RH_NPC_MKT_HY_AHG_2)
RANDO_ENUM_ITEM(RH_NPC_MKT_HY_AHG_20)
RANDO_ENUM_ITEM(RH_NPC_MKT_HY_AHG_4)
RANDO_ENUM_ITEM(RH_NPC_MKT_HY_AOB)
RANDO_ENUM_ITEM(RH_NPC_MKT_HY_BBA)
RANDO_ENUM_ITEM(RH_NPC_MKT_HY_BJI_15)
RANDO_ENUM_ITEM(RH_NPC_MKT_HY_BJI_19)
RANDO_ENUM_ITEM(RH_NPC_MKT_HY_BOJ_14)
RANDO_ENUM_ITEM(RH_NPC_MKT_HY_BOJ_16)
RANDO_ENUM_ITEM(RH_NPC_MKT_HY_BOJ_3)
RANDO_ENUM_ITEM(RH_NPC_MKT_HY_BOJ_5)
RANDO_ENUM_ITEM(RH_NPC_MKT_HY_CNE_11)
RANDO_ENUM_ITEM(RH_NPC_MKT_HY_CNE_8)
RANDO_ENUM_ITEM(RH_NPC_MKT_HY_COB)
RANDO_ENUM_ITEM(RH_NPC_MKT_MASK_CUSTOMER)
RANDO_ENUM_ITEM(RH_NPC_SHOP_BAZAAR_KAK)
RANDO_ENUM_ITEM(RH_NPC_SHOP_BAZAAR_MARKET)
RANDO_ENUM_ITEM(RH_NPC_SHOP_BOMBCHU)
RANDO_ENUM_ITEM(RH_NPC_SHOP_MARKET_POTION)
RANDO_ENUM_ITEM(RH_NPC_SHOP_MASK)
RANDO_ENUM_ITEM(RH_NPC_SHOP_ZORA)
RANDO_ENUM_ITEM(RH_NPC_ZD_KING_ZORA)
RANDO_ENUM_ITEM(RH_NPC_ZD_RUTO)
RANDO_ENUM_ITEM(RH_NPC_ZD_ZORA_0)
RANDO_ENUM_ITEM(RH_NPC_ZD_ZORA_1)
RANDO_ENUM_ITEM(RH_NPC_ZD_ZORA_2)
RANDO_ENUM_ITEM(RH_NPC_ZD_ZORA_3)
RANDO_ENUM_ITEM(RH_NPC_ZD_ZORA_4)
RANDO_ENUM_ITEM(RH_NPC_ZD_ZORA_5)
RANDO_ENUM_ITEM(RH_NPC_ZF_ZORA_6)
RANDO_ENUM_ITEM(RH_NPC_ZF_ZORA_7)
RANDO_ENUM_ITEM(RH_NPC_ZR_ZORA_8)
RANDO_ENUM_ITEM(RH_NPC_FT_GORON_PILLAR)
RANDO_ENUM_ITEM(RH_NPC_FT_GORON_FLAME_DANCER)
RANDO_ENUM_ITEM(RH_NPC_FT_GORON_FALLING_DOORS)
RANDO_ENUM_ITEM(RH_NPC_FT_GORON_OCARINA)
RANDO_ENUM_ITEM(RH_NPC_FT_GORON_HIDDEN_DOOR)
RANDO_ENUM_ITEM(RH_NPC_FT_GORON_ENTRANCE)
RANDO_ENUM_ITEM(RH_NPC_FT_GORON_LAVA_ROOM_BOMB)
// <<< SEVEN_SAGES_GENERATED: RH_NPC
