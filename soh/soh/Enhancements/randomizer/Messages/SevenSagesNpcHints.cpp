...
constexpr NpcHintSpeaker npcHintSpeakers[] = {
    ...
    { ACTOR_EN_GO2, SCENE_DEATH_MOUNTAIN_TRAIL, 0x1F, 4, 0,
      RH_NPC_DMT_GORON_BOMB_FLOWER }, // Death Mountain Trail Goron Bomb Flower
    { ACTOR_EN_GO2, SCENE_DEATH_MOUNTAIN_TRAIL, 0x1F, 6, 0, RH_NPC_DMT_GORON_DC }, // Death Mountain Trail Goron Dc
    { ACTOR_EN_GO2, SCENE_DEATH_MOUNTAIN_TRAIL, 0x1F, 12, 0,
      RH_NPC_DMT_GORON_FAIRY }, // Death Mountain Trail Goron Fairy
    { ACTOR_EN_GO2, SCENE_DEATH_MOUNTAIN_TRAIL, 0x1F, 5, 0,
      RH_NPC_DMT_GORON_ROLLING },                                              // Death Mountain Trail Goron Rolling
    ...
    { ACTOR_EN_GE2, SCENE_GERUDOS_FORTRESS, 0xFF, 2, 0,
      RH_NPC_GF_GERUDO_CARD_GIVER }, // Gerudo Fortress Gerudo Card Giver
    { ACTOR_EN_GE1, SCENE_GERUDOS_FORTRESS, 0xFF, 0, 0,
      RH_NPC_GF_GERUDO_GATE_GUARD },                                                // Gerudo Fortress Gerudo Gate Guard
    ...
    { ACTOR_EN_GE2, SCENE_GERUDOS_FORTRESS, 0xFF, 1, 0,
      RH_NPC_GF_GERUDO_STATIONARY }, // Gerudo Fortress Gerudo Stationary
    ...
    { ACTOR_EN_DAIKU, SCENE_THIEVES_HIDEOUT, 0x03, 1, 0,
      RH_NPC_TH_CARP_DEAD_END },                                                  // Thieves' Hideout carpenter Dead End
    ...
    { ACTOR_EN_DAIKU_KAKARIKO, SCENE_KAKARIKO_VILLAGE, 0x03, 0, 0,
      RH_NPC_KAK_CARP_ICHIRO },                                                            // Kakariko carpenter Ichiro
    { ACTOR_EN_DAIKU_KAKARIKO, SCENE_KAKARIKO_VILLAGE, 0x03, 1, 0, RH_NPC_KAK_CARP_JIRO }, // Kakariko carpenter Jiro
    { ACTOR_EN_DAIKU_KAKARIKO, SCENE_KAKARIKO_VILLAGE, 0x03, 2, 0,
      RH_NPC_KAK_CARP_SABOORO }, // Kakariko carpenter Sabooro
    ...
    { ACTOR_EN_KO, SCENE_SARIAS_HOUSE, 0xFF, 6, 0, RH_NPC_KOKIRI_10 },                       // Sarias House Kokiri 6
    { ACTOR_EN_KO, SCENE_KOKIRI_SHOP, 0xFF, 10, 0, RH_NPC_KOKIRI_11 },                       // Kokiri Shop Kokiri 10
    ...
    { ACTOR_EN_KO, SCENE_MIDOS_HOUSE, 0xFF, 0, 0, RH_NPC_KOKIRI_7 },                         // Midos House Kokiri 0
    { ACTOR_EN_KO, SCENE_MIDOS_HOUSE, 0xFF, 4, 0, RH_NPC_KOKIRI_8 },                         // Midos House Kokiri 4
    { ACTOR_EN_KO, SCENE_KOKIRI_SHOP, 0xFF, 5, 0, RH_NPC_KOKIRI_9 },                         // Kokiri Shop Kokiri 5
    ...
    { ACTOR_EN_GO2, SCENE_FIRE_TEMPLE, 0xFC00, 0x1000, 0x3071,
      RH_NPC_FT_GORON_FLAME_DANCER }, // Fire Temple Goron Flame Dancer
    { ACTOR_EN_GO2, SCENE_FIRE_TEMPLE, 0xFC00, 0x0C00, 0x3071,
      RH_NPC_FT_GORON_FALLING_DOORS }, // Fire Temple Goron Falling Doors
    { ACTOR_EN_GO2, SCENE_FIRE_TEMPLE, 0xFC00, 0x2800, 0x3071, RH_NPC_FT_GORON_OCARINA }, // Fire Temple Goron Ocarina
    { ACTOR_EN_GO2, SCENE_FIRE_TEMPLE, 0xFC00, 0x2C00, 0x3071,
      RH_NPC_FT_GORON_HIDDEN_DOOR }, // Fire Temple Goron Hidden Door
    { ACTOR_EN_GO2, SCENE_FIRE_TEMPLE, 0xFC00, 0x2400, 0x3071, RH_NPC_FT_GORON_ENTRANCE }, // Fire Temple Goron Entrance
    { ACTOR_EN_GO2, SCENE_FIRE_TEMPLE, 0xFC00, 0x0800, 0x3071,
      RH_NPC_FT_GORON_LAVA_ROOM_BOMB }, // Fire Temple Goron Lava Room Bomb
...
RandomizerHint FindHintForCurrentTalkActor(uint16_t textId) {
    ...
    SPDLOG_INFO("[SevenSages] unclaimed NPC: actor={} scene={} params=0x{:04X}", talkActor->id, gPlayState->sceneNum,
                static_cast<uint16_t>(talkActor->params));
    return RH_NONE;
}
