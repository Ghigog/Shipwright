...
const std::vector<PropDef>& AllProps() {
    ...
    static const std::vector<PropDef> props = {
        ...
        { "Boulder, bronze", ACTOR_OBJ_HAMISHI, OBJECT_GAMEPLAY_FIELD_KEEP, kNoObjectNeeded, 0, "Hammer-breakable." },
...
static const char* const kGroupOrder[] = {
    "Plants & ground", "Rocks & breakables", "Creatures",       "Fire & light", "Water & ice",
    "Structures",      "Machinery",          "Sound & effects", "Other",
};
...
static const struct {
    ...
    { ACTOR_EN_WOOD02, "Plants & ground" },
    { ACTOR_OBJ_HANA, "Plants & ground" },
    { ACTOR_EN_KUSA, "Plants & ground" },
    { ACTOR_OBJ_MURE2, "Plants & ground" },
    { ACTOR_OBJ_COMB, "Plants & ground" },
    { ACTOR_DOOR_ANA, "Plants & ground" },

    { ACTOR_EN_ISHI, "Rocks & breakables" },
    { ACTOR_OBJ_HAMISHI, "Rocks & breakables" },
    { ACTOR_OBJ_BOMBIWA, "Rocks & breakables" },
    { ACTOR_OBJ_TSUBO, "Rocks & breakables" },
    { ACTOR_OBJ_KIBAKO, "Rocks & breakables" },
    { ACTOR_OBJ_KIBAKO2, "Rocks & breakables" },
    { ACTOR_EN_BOMBF, "Rocks & breakables" },
    { ACTOR_BG_HAKA_TUBO, "Rocks & breakables" },
    { ACTOR_BG_SPOT18_BASKET, "Rocks & breakables" },
    { ACTOR_BG_SPOT15_RRBOX, "Rocks & breakables" },
    { ACTOR_EN_TUBO_TRAP, "Rocks & breakables" },
    { ACTOR_BG_BOMBWALL, "Rocks & breakables" },
    ...
    { ACTOR_BG_SPOT17_BAKUDANKABE, "Rocks & breakables" },
    { ACTOR_DEMO_GJ, "Rocks & breakables" },

    { ACTOR_OBJ_MURE, "Creatures" },
    { ACTOR_EN_FISH, "Creatures" },
    { ACTOR_EN_INSECT, "Creatures" },
    { ACTOR_EN_BUTTE, "Creatures" },
    { ACTOR_EN_NIW, "Creatures" },
    { ACTOR_EN_HORSE_NORMAL, "Creatures" },
    { ACTOR_EN_HORSE_LINK_CHILD, "Creatures" },

    { ACTOR_EN_LIGHT, "Fire & light" },
    { ACTOR_OBJ_SYOKUDAI, "Fire & light" },
    { ACTOR_BG_PO_SYOKUDAI, "Fire & light" },
    { ACTOR_EN_ICE_HONO, "Fire & light" },
    { ACTOR_EFC_ERUPC, "Fire & light" },
    { ACTOR_BG_TOKI_HIKARI, "Fire & light" },

    { ACTOR_BG_ICE_TURARA, "Water & ice" },
    { ACTOR_BG_ICE_SHELTER, "Water & ice" },
    { ACTOR_EN_SIOFUKI, "Water & ice" },
    { ACTOR_EN_STREAM, "Water & ice" },
    { ACTOR_BG_MIZU_UZU, "Water & ice" },
    { ACTOR_BG_SPOT07_TAKI, "Water & ice" },
    { ACTOR_BG_ICE_OBJECTS, "Water & ice" },
    { ACTOR_BG_GND_ICEBLOCK, "Water & ice" },
    { ACTOR_BG_SPOT08_ICEBLOCK, "Water & ice" },

    { ACTOR_EN_KANBAN, "Structures" },
    { ACTOR_EN_GS, "Structures" },
    { ACTOR_BG_HAKA, "Structures" },
    { ACTOR_EN_HATA, "Structures" },
    { ACTOR_BG_UMAJUMP, "Structures" },
    { ACTOR_BG_INGATE, "Structures" },
    { ACTOR_EN_TANA, "Structures" },
    { ACTOR_OBJ_HSBLOCK, "Structures" },
    { ACTOR_BG_SPOT09_OBJ, "Structures" },
    { ACTOR_BG_SPOT00_HANEBASI, "Structures" },
    { ACTOR_BG_SPOT00_BREAK, "Structures" },
    { ACTOR_BG_SPOT01_IDOSOKO, "Structures" },
    { ACTOR_BG_HIDAN_DALM, "Structures" },
    { ACTOR_BG_MENKURI_NISEKABE, "Structures" },
    { ACTOR_BG_GND_NISEKABE, "Structures" },
    { ACTOR_BG_JYA_ZURERUKABE, "Structures" },
    { ACTOR_BG_GND_SOULMEIRO, "Structures" },
    { ACTOR_BG_HIDAN_ROCK, "Structures" },
    { ACTOR_BG_JYA_BLOCK, "Structures" },
    { ACTOR_BG_GND_DARKMEIRO, "Structures" },
    { ACTOR_OBJ_OSHIHIKI, "Structures" },
    { ACTOR_OBJ_MAKEOSHIHIKI, "Structures" },
    { ACTOR_OBJ_BLOCKSTOP, "Structures" },

    { ACTOR_BG_HIDAN_SIMA, "Machinery" },
    { ACTOR_BG_HIDAN_HROCK, "Machinery" },
    { ACTOR_BG_HIDAN_SYOKU, "Machinery" },
    { ACTOR_BG_HIDAN_FSLIFT, "Machinery" },
    { ACTOR_BG_JYA_1FLIFT, "Machinery" },
    { ACTOR_BG_MENKURI_KAITEN, "Machinery" },
    { ACTOR_BG_JYA_AMISHUTTER, "Machinery" },
    { ACTOR_OBJ_LIFT, "Machinery" },
    { ACTOR_BG_GANON_OTYUKA, "Machinery" },
    { ACTOR_BG_GND_FIREMEIRO, "Machinery" },
    { ACTOR_BG_HIDAN_FIREWALL, "Machinery" },
    { ACTOR_BG_HIDAN_SEKIZOU, "Machinery" },
    { ACTOR_BG_HIDAN_RSEKIZOU, "Machinery" },
    { ACTOR_EN_HONOTRAP, "Machinery" },
    { ACTOR_EN_TRAP, "Machinery" },
    { ACTOR_BG_HAKA_TRAP, "Machinery" },
    { ACTOR_BG_JYA_GOROIWA, "Machinery" },
    { ACTOR_BG_RELAY_OBJECTS, "Machinery" },
    { ACTOR_BG_SPOT01_FUSYA, "Machinery" },

    { ACTOR_EN_RIVER_SOUND, "Sound & effects" },
    { ACTOR_EN_WEATHER_TAG, "Sound & effects" },
    { ACTOR_BG_SPOT16_DOUGHNUT, "Sound & effects" },
    { ACTOR_OBJ_MURE3, "Sound & effects" },
};
