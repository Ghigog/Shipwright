...
class Anchor : public Network {
  private:
    ...
    void HandlePacket_SevenSagesStash(nlohmann::json payload);
  ...
  public:
    ...
    // Seven Sages trade box: the shared stash, broadcast whole on every change.
    // See Packets/SevenSagesStash.cpp.
    inline static const std::string SEVEN_SAGES_STASH = "SEVEN_SAGES_STASH";
    ...
    void SendPacket_SevenSagesStash();
